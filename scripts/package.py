...
if __name__ == "__main__":
    ...
    if host_platform == "linux":
        ...
        print(f"Unsupported platform [{host_platform}]. Only Linux is supported.")
        sys.exit(1)
